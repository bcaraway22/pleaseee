...
(function (global, factory) {
  ...
  var Template7Utils = {
    ...
    helperToSlices: function helperToSlices(string) {
      ...
      for (i = 0; i < helperParts.length; i += 1) {
        ...
        if (i === 0) {
          ...
          blockQuoteRegExp =
            part.indexOf('"') === 0 ? quoteDoubleRexExp : quoteSingleRexExp;
      ...
      for (var i = 0; i < parts.length; i += 1) {
        ...
        if (part.indexOf("@") === 0) {
          ...
          Number.isFinite
            ...
            : Template7Context.isFinite(part)
        ) {
          variable += "[" + part + "]";
        } else if (
          part === "this" ||
    ...
    getCompiledArguments: function getCompiledArguments(
      contextArray,
      ctx,
      data
    ) {
